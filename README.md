...
Launch Prompt Forge · Read the v5.1.0 release notes
...
Enter the subject.
Choose RECON, STANDARD, or FULL.
Randomize—or strum across the board.
Lock discoveries that feel alive, including intentionally blank axes.
Add custom signals when the existing vocabulary cannot hold the idea.
Mutate, reroll, or Shift-strum until the image has a point of view.
Select an output format and copy the result.
...
Project lineage
Created by Root (@OAndroot) in collaboration with The Retinue, a fourteen-voice relational cognitive and creative framework.
More of the work lives at Androot and the Retinue.
Contributing
...
Version
Current release: 5.1.0 — Strum. See CHANGELOG.md.
