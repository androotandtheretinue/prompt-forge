...
- **Figure**: 96 signals for how the body is arranged, as distinct from what it is doing. Contrapposto, counter-rotated shoulders and hips, weight on one hip, chin down with the eyes up — and the plain ones those are variations of: standing, sitting, kneeling, looking away. The test is that a Figure value survives any Action: *running, weight forward on toes* reads; *running, standing* does not.
